...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/verification/store-manual', [BillVerificationController::class, 'storeManualBill'])->middleware('read.only')->name('verification.store_manual');
    ...
    Route::get('/payment-classification/export-excel', [PaymentClassificationController::class, 'exportExcel'])->name('payment.export_excel');
    Route::get('/payment-classification/export-pdf', [PaymentClassificationController::class, 'exportPdf'])->name('payment.export_pdf');
    ...
    Route::get('/corrections/export-excel', [CorrectionsController::class, 'exportExcel'])->name('corrections.export_excel');
    ...
    Route::get('/pso-summary/export-excel', [PsoSummaryController::class, 'exportExcel'])->name('summary.export_excel');
    Route::get('/pso-summary/export-pdf', [PsoSummaryController::class, 'exportPdf'])->name('summary.export_pdf');
    Route::get('/pso-summary/{id}', [PsoSummaryController::class, 'show'])->name('summary.show');
    Route::get('/pso-summary/{id}/export-excel', [PsoSummaryController::class, 'exportSingleExcel'])->name('summary.export_single_excel');
    Route::get('/pso-summary/{id}/export-pdf', [PsoSummaryController::class, 'exportSinglePdf'])->name('summary.export_single_pdf');

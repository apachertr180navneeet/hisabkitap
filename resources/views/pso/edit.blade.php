      ...
      <div class="card border bg-white shadow-sm mb-4">
        ...
        <div class="card-body p-4">
          <div id="series-rows-container">
            ...
            {{-- Series Row --}}
            <div class="row g-2 align-items-end series-row mb-3" data-row-index="{{ $idx }}">
              ...
              <div class="col-md-2">
                ...
                <input type="number" name="series[{{ $idx }}][start_no]" class="form-control font-mono input-start" 
                       value="{{ $rng['start_no'] }}" min="1" required>
              ...
              <div class="col-md-3">
                ...
                <input type="number" name="series[{{ $idx }}][end_no]" class="form-control font-mono input-end" 
                       value="{{ $rng['end_no'] }}" min="1" required>
              ...
              <div class="col-md-1 text-center">
                ...
                <button type="button" class="btn btn-outline-danger w-100 btn-remove-row" 
                        style="{{ count($ranges) > 1 ? '' : 'display: none;' }}" title="Delete this range">
          ...
          <div class="d-flex justify-content-between align-items-center pt-1 pb-1">
            ...
            <span class="text-muted small">
              <i class="bi bi-layers text-primary me-1"></i><span id="series-row-count">{{ count($ranges) }}</span> Range(s) Configured
            </span>
          </div>

      ...
      <div class="card border bg-white shadow-sm mb-4">
        <div class="card-header bg-white py-3 px-4 border-bottom d-flex justify-content-between align-items-center">
          ...
          @if(isset($currentUser) && $currentUser)
            <span class="badge bg-primary-subtle text-primary border font-mono small py-1 px-2">
              <i class="bi bi-person-check me-1"></i>Created by: <strong>{{ $currentUser->name }}</strong>
            </span>
          @endif
        </div>
              ...
              <div class="row g-2 align-items-center">
                ...
                <div class="col-md-3">
                  ...
                  <div class="input-group input-group-sm">
                    ...
                    <select name="series[0][prefix]" class="form-select form-select-sm font-mono fw-bold select-prefix" required>
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function updatePreview() {
    ...
    rows.forEach((row) => {
      ...
      let prefix = sel ? sel.value.trim() : 'CB';
